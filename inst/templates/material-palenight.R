rstheme(
  ...
  theme_dark    = TRUE,
  theme_flat    = TRUE,
  theme_path    = here::here("inst/templates/material-palenight.scss"),
  theme_apply   = TRUE,
  theme_as_sass = TRUE,
  theme_palette = list(
    base00 = "#222736",
  ...
  ui_completions_foreground         = "$base07",
  ui_completions_selected_foreground = "$base07",
